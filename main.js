...
function mapApp() {
	...
	var model = {
		...
		iconLibrary: { 
			...
			'coffee': 'cafe.png',
			'tea': 'cafe.png',
			'galleries': 'museum.png',
			'museums': 'museum.png',	
			'landmarks': 'museum.png',
			'indian': 'restaurant.png',
			'indpak': 'restaurant.png',
			'mexican': 'restaurant.png',
			'french': 'restaurant.png',
			'gastropub': 'restaurant.png',
			'english': 'restaurant.png',
			'scottish': 'restaurant.png',
			'turkish': 'restaurant.png',
			'italian': 'restaurant.png',
			'steak': 'restaurant.png',
			'burgers': 'restaurant.png',
			'seafood': 'restaurant.png',
			'british': 'restaurant.png',
			'modern_european': 'restaurant.png',
			'sandwiches': 'restaurant.png',
			'vegetarian': 'restaurant.png',
			'football': 'sports.png',
			'stadiumsarenas': 'sports.png'
		},

		defaultIcon: 'other.png'
	...
	var mapView = {
		...
		createMarker: function(place) {
			...
			'<img class="info-yelp" src="yelp_powered_btn_dark.png" ></img>' +
			'</div>';
